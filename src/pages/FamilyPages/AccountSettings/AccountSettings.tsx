...
import { EditProfile } from "./AccountsettingTabs/EditProfile";
...
export const AccountSettings = (): JSX.Element => {
    ...
    const handleTabChange = (id: string) => {
        if (id === "delete-account") {
            ...
            navigate("/family/subscription");
        } else if (id === "help-center") {
            navigate("/family/help-center");
        } else {
            setActiveTab(id);
    ...
    const renderActiveTab = () => {
        ...
        if (activeTab === "my-profile" && isEditMode) {
            return <EditProfile onCancel={handleEditCancel} onSave={handleEditSave} />;
        }
